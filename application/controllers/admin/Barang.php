...
class Barang extends CI_Controller
{
    ...
    public function cetakKartu($kode)
    {
        ...
        $html = $this->load->view('admin/kartu_persediaan', $data, true);
    ...
    public function cetakLaporanPersediaan()
    {
        ...
        //load the view and saved it into $html variable
        $html = $this->load->view('admin/Laporan_persediaan', $data, true);
        //this the the PDF filename that user will get to download
        $pdfFilePath = 'output_pdf_name.pdf';
        //load mPDF library
        $this->load->library('m_pdf');
    ...
    public function cetakLaporanPersediaanBulanan()
    {
        ...
        //load the view and saved it into $html variable
        $html = $this->load->view('admin/Laporan_Gudang', $data, true);
        //this the the PDF filename that user will get to download
        $pdfFilePath = 'output_pdf_name.pdf';
        //load mPDF library
        $this->load->library('m_pdf');
