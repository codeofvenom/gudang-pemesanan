      ...
      <ul class="sidebar-menu" >
        ...
        <li class="active treeview">
          <a href="#">
			...
			<ul class="treeview-menu">
            	<li class="active"><a href="<?php echo base_url().'administrator/client'; ?>"><i class="fa fa-users"></i> Data Client</a></li>
 ...
 <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'administrator/client/simpan_client'; ?>" method="post" enctype="multipart/form-data">
        ...
        ?>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'administrator/client/update_client'; ?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
						            <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Nama</label>
                                        <div class="col-sm-7">
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id_client; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'administrator/client/hapus_client'; ?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
							<input type="hidden" name="kode" value="<?php echo $id_client; ?>"/>
...
<script>
 ...
 $(document).ready(function(){  
      $('#xusername').change(function(){  
           ...
           {  
                $.ajax({  
                     url:"<?php echo base_url(); ?>administrator/client/check_username_avalibility",  
                     method:"POST",  
