    ...
    <a href="<?php echo base_url().'administrator/beranda'; ?>" class="logo">
						     ...
						     <?php
                                        ...
                                        $q = $this->db->query("SELECT foto,nama,username,DATE_FORMAT(last_login,'%H:%i:%s') AS last_login_time,
																				DATE_FORMAT(last_login,'%Y-%m-%d') AS last_login	
																				 FROM tb_admin WHERE id_admin='$id_admin'");
                                        $c = $q->row_array();
                                        ?>
              <img src="<?php echo base_url().'assets/img/avatar/admin/'.$c['foto']; ?>" class="user-image" alt="">
							<span class="hidden-xs"><?php echo ucfirst($c['nama']); ?></span>
							&emsp;<i class="fa fa-caret-down"></i>
            </a>
            <ul class="dropdown-menu">
              <li class="user-header">
                <img src="<?php echo base_url().'assets/img/avatar/admin/'.$c['foto']; ?>" class="img-circle" alt="">
              ...
              <li class="user-footer">
								<div class="pull-left">
                  <a href="<?php echo base_url().'administrator/admin/edit_profilku'; ?>" class="btn btn-default btn-flat"><i class="fa fa-user"> Edit Profil</i></a>
                </div>
