...
?>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" >
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url().'administrator/pengumuman'; ?>"><i class="fa fa-newspaper-o"></i> Data Pengumuman</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-newspaper-o"></i> Data Pengumuman </a></li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal"><span class="fa fa-plus"></span> Tambah Data Pengumuman</a>
            </div>
            <!-- /.box-header -->
            ...
            ?>
                <tr>
                  ...
                  <td><?php echo $isi; ?></td>
									<td><?php echo $katg; ?></td>
                  <td><?php echo longdate_indo($tanggal); ?> <?php echo $waktu; ?></td>
   ...
   <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'administrator/pengumuman/simpan_pengumuman'; ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-sm-7">
                                   <select class="form-control select2" name="xkategori" style="width: 100%;" required>
                                                                            ...
                                                                            foreach ($kat->result_array() as $i) :
                                                                                $no++;
                                                                                                                                                        $id_kategori_png = $i['id_kategori_png'];
                                                                            $nama_kategori = $i['nama_kategori'];
                                                                            ?>
                  										<option value="<?php echo $id_kategori_png; ?>"><?php echo $nama_kategori; ?></option>
				  														<?php endforeach; ?>
               											 </select>
                                </div>
                            </div>
							...
							<div class="modal fade" id="ModalEdit<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
									<div class="modal-dialog" role="document">
											<div class="modal-content">
													...
													<form class="form-horizontal" action="<?php echo base_url().'administrator/pengumuman/update_pengumuman'; ?>" method="post" enctype="multipart/form-data">
													<div class="modal-body">
                                ...
                                <div class="col-sm-7">
                                   <select class="form-control select2" name="xkategori" style="width: 100%;" required>
                                                                            ...
                                                                            foreach ($kat->result_array() as $i) {
                                                                                $id_kategori_png = $i['id_kategori_png'];
                                                                                $nama_kategori = $i['nama_kategori'];
                                                                                if ($idka == $id_kategori_png) {
                                                                                    echo "<option value='$id_kategori_png' selected>$nama_kategori</option>";
                                                                                } else {
                                                                                    echo "<option value='$id_kategori_png'>$nama_kategori</option>";
                                                                                }
                                                                            } ?>
               											 </select>
                                </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'administrator/pengumuman/hapus_pengumuman'; ?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
							<input type="hidden" name="kode" value="<?php echo $id; ?>"/>
