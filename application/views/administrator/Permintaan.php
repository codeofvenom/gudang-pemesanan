...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-truck"></i> Permintaan Pesanan </a></li>
      </ol>
    </section>
              ...
              <table id="example1" class="table table-striped table-bordered table-responsive" style="width:100%;font-size:13px;">
				...
				<tr>
					...
					<td style="text-align:center;">	
						<span data-toggle="tooltip" data-placement="top" data-original-title="Terima Pesanan Barang">
							<a data-toggle="modal" data-target="#ModalTerima<?php echo $id; ?>">
								<button type="button" class="btn btn-info btn-xs" title="Terima"><i class="fa fa-check"></i> Terima</button>
							</a>
						</span>	
					<span data-toggle="tooltip" data-placement="top" data-original-title="Tolak Pesanan Barang">
							<a data-toggle="modal" data-target="#ModalTolak<?php echo $id; ?>">
					   			<button type="button" class="btn btn-danger btn-xs" title="Terima"><i class="fa fa-times"></i> Tolak</button>
							</a>
					</span>			
					</td>
			</tr>		
...
$nama_instansi = $i['nama_instansi'];
?>
        <div class="modal fade" id="ModalTerima<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'administrator/permintaan/terima'; ?>" method="post" enctype="multipart/form-data">
              ...
              <input type="hidden" name="kode3" value="<?php echo $nama_instansi; ?>"/>
                            <p>Apakah Anda yakin mau menyetujui Data Transaksi  pesanan barang  <b><?php echo $kode_transaksi; ?></b> dengan nama barang
        ...
        <div class="modal fade" id="ModalTolak<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                        <h4 class="modal-title" id="myModalLabel">Tolak Data Transaksi Barang</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'administrator/permintaan/tolak'; ?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
							<input type="hidden" name="kode" value="<?php echo $id; ?>"/>
							<input type="hidden" name="kode2" value="<?php echo $idb; ?>"/>
							<input type="hidden" name="kode3" value="<?php echo $jumlah; ?>"/>
                            <p>Apakah Anda yakin mau menolak Data Transaksi  pesanan barang  <b><?php echo $kode_transaksi; ?></b> dengan nama barang
							<b><?php echo $nama_barang; ?></b> dari Instansi <b><?php echo strtoupper($nama_instansi); ?></b> ?</p>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default btn-flat" data-dismiss="modal"><i class="fa fa-close"></i> Close</button>
                        <button type="submit" class="btn btn-danger btn-flat"><i class="fa fa-times"></i> Tolak</button>
                    </div>
                    </form>
                </div>
            </div>
