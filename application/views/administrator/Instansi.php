        ...
        <li class="active treeview">
          <a href="#">
			...
			<ul class="treeview-menu">
            	...
            	<li class="active"><a href="<?php echo base_url().'administrator/instansi'; ?>"><i class="fa fa-building-o"></i>  Data Instansi</a></li>
          </ul>
        </li>
        ...
        <div class="modal" id="myModal" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog modal-md" role="document">
                <div class="modal-content">
                    ...
                    <form class="form" action="<?php echo base_url().'administrator/instansi/simpan_instansi'; ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="modal fade" id="ModalEdit<?php echo $id_instansi; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'administrator/instansi/update_instansi'; ?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                      <div class="form-group row">
                           <label for="inputUserName" class="col-sm-3 control-label"><h5>	Nama Instansi </h5></label>
                            <div class="col-sm-9">
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id_instansi; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'administrator/instansi/hapus_instansi'; ?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
														<input type="hidden" name="kode" value="<?php echo $id_instansi; ?>"/>
