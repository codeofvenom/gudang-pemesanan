        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url().'administrator/barang'; ?>"><i class="fa fa-briefcase"></i> Data Barang</a></li>
             <li class="active"><a href="<?php echo base_url().'administrator/masuk'; ?>"><i class="fa fa-plus"></i> Tambah Barang Masuk</a></li>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal"><span class="fa fa-plus"></span> Tambah Barang Masuk</a>
              &nbsp;
              <a href="<?=site_url('administrator/masuk/cetakStokOpname'); ?>" target="_blank">
                <button type="button" class="btn btn-primary"><img src="<?php echo base_url(); ?>assets/img/img/pdf-icon.png" alt="" width="15px" /> Cetak Stock Opname </button>
              </a>
            </div>
            <!-- /.box-header -->
                ...
                <tbody>
                            ...
                            $no = 0;
                             foreach ($data->result_array() as $i) :
                                    $no++;
                                    $id_barang_so = $i['id_barang_so'];
                                    $nama_barang_so = $i['nama_barang'];
                                    $satuan = $i['satuan'];
                                    $harga = $i['harga'];
							 	...
							 	<tr>
										...
										<td style="width:18%;text-align:center;">	
												<span data-toggle="tooltip" data-placement="top" data-original-title="Edit Barang">
													<a data-toggle="modal" data-target="#ModalEdit<?php echo $id_barang_so; ?>">
...
<footer class="main-footer">
 ...
 <aside class="control-sidebar control-sidebar-dark">
    <div class="tab-content">
        ...
        ?>
        <div class="modal fade" id="ModalEdit<?php echo $id_barang_so; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'administrator/masuk/update_stock'; ?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">

						<div class="form-group">
											<label for="inputUserName" class="col-sm-4 control-label">Nama Barang</label>
												<div class="col-sm-7">
												<input type="hidden" name="kode" value="<?php echo $id_barang_so; ?>" readonly/>
												<input type="hidden" name="idb" value="<?php echo $idb; ?>" readonly/>
												<input type="hidden" name="kodex" value="<?php echo $kode_transaksi; ?>" readonly/>
                          <select class="selectpicker show-tick form-control"  style="width: 100%;"  data-live-search="true" disabled>
																<?php
                                                            foreach ($brg->result_array() as $i) {
                                                                $id_barang = $i['id_barang'];
                                                                $nama_barang = $i['nama_barang'];
                                                                if ($idb == $id_barang) {
                                                                    echo "<option value='$id_barang' selected>$nama_barang </option>";
                                                                } else {
                                    ...
                                    <div class="form-group">
                                        <label for="inpuUsername2" class="col-sm-4 control-label">Jumlah Stock Barang</label>
										<div class="row">
											 <div class="col-sm-2">
                                            	<input type="text" class="form-control"  value="<?php echo $jumlah_stock; ?>" disabled>
                                        	</div> 
											<div class="col-sm-4">
												<div class="form-group">
                                            		<input type="text" name="xstock" class="form-control"  placeholder="Jumlah Stock Barang">
                                        		</div>
											</div> 
										</div>
									</div>	
                                    <div class="form-group">
                                        <label for="inpuUsername2" class="col-sm-4 control-label">Jumlah Stock Rusak Barang</label>
										<div class="row">
											 <div class="col-sm-2">
                                    ...
                                    <?php endif; ?>
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xprtgl" class="form-control pull-right"  value="<?php echo $tgl_produksi; ?>"  id="tanggal4" placeholder="Tanggal Produksi Barang" required>
                                        </div>
										</div>
																		</div>
																	<div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xmtgl" class="form-control pull-right"  value="<?php echo $tgl_masuk; ?>" id="tanggal5" placeholder="Tanggal Masuk Barang" required>
                                        </div>
																		</div>
																		<div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xtgl" class="form-control pull-right" value="<?php echo $tgl_expired; ?>" id="tanggal6" placeholder="Tanggal Expired" required>
                                        </div>
																		</div>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'administrator/masuk/simpan_barang'; ?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
								<div class="form-group">
									<label for="inputUserName" class="col-sm-4 control-label">Nama Barang</label>
									<div class="col-sm-7">
                                  	 <select class="selectpicker show-tick form-control" name="xnama" style="width: 100%;"  data-live-search="true" title="Pilih Nama Barang" required>
															<?php
                                                        foreach ($brg->result_array() as $i) :
                                                            $id_barang = $i['id_barang'];
                                                        $nama_barang = $i['nama_barang'];
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label for="inpuUsername2" class="col-sm-4 control-label">Tanggal Produksi Barang</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xprtgl" class="form-control pull-right"  id="tanggal" placeholder="Tanggal Produksi Barang" required>
                                        </div>
										</div>
											<div class="form-group">
                                        <label for="inpuUsername2" class="col-sm-4 control-label">Tanggal Masuk Barang</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xmtgl" class="form-control pull-right"  id="tanggal2" placeholder="Tanggal Masuk Barang" required>
                                        </div>
																		</div>
																		<div class="form-group">
                                        <label for="inpuUsername2" class="col-sm-4 control-label">No Batch</label>
                                        ...
                                        <label for="inpuUsername2" class="col-sm-4 control-label">Tanggal Expired</label>
                                        <div class="col-sm-7">
                                            <input type="text" name="xtgl" class="form-control pull-right"  id="tanggal3" placeholder="Tanggal Expired" required>
                                        </div>
																		</div>
