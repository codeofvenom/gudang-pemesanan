      ...
      <ul class="sidebar-menu" >
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url().'administrator/barang'; ?>"><i class="fa fa-briefcase"></i> Data Barang</a></li>
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-header">
              ...
              &nbsp;
              <a href="<?=site_url('administrator/barang/cetakLaporanPersediaan'); ?>" target="_blank">
              ...
              &nbsp;
              <a href="<?=site_url('administrator/barang/cetakLaporanPersediaanBulanan'); ?>" target="_blank">
							 	...
							 	<tr>
										...
										<td style="width:18%;text-align:center;">	
												<span data-toggle="tooltip" data-placement="top" data-original-title="Lihat Detail Barang">
													<a href="<?php echo base_url().'administrator/barang/detail/'.$id_barang; ?>">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'administrator/barang/update_barang'; ?>" method="post" enctype="multipart/form-data">
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'administrator/barang/simpan_barang'; ?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
						            <div class="form-group">
                                        <label for="inputUserName" class="col-sm-4 control-label">Nama Barang</label>
                                        <div class="col-sm-7">
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id_barang; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'administrator/barang/hapus_barang'; ?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
