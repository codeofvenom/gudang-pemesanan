    ...
    <a href="<?php echo base_url().'admin/beranda'; ?>" class="logo">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
								<div class="pull-left">
                  <a href="<?php echo base_url().'admin/admin/edit_profilku'; ?>" class="btn btn-default btn-flat"><i class="fa fa-user"> Edit Profil</i></a>
                </div>
