    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" >
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url().'admin/proses'; ?>"><i class="fa fa-spinner"></i> Data Barang Diproses</a></li>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <a href="<?= site_url('admin/proses/cetakKartuPengeluaran/'.$kode_transaksi.''); ?>" target="_blank"><img src="<?php echo base_url(); ?>assets/img/img/pdf-icon.png" alt="" width="15px" /> Cetak Kartu Pengeluaran</a>
            &nbsp;	
        ...
        <div class="modal fade" id="ModalSelesai<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/proses/selesai'; ?>" method="post" enctype="multipart/form-data">
