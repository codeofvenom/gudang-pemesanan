 ...
 <aside class="main-sidebar" >
      ...
      <ul class="sidebar-menu" >
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo base_url().'administrator/kategoripng'; ?>"><i class="fa fa-list"></i> Kategori Pengumuman</a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-briefcase"></i> Pengumuman </a></li>
        <li class="active">  Kategori Pengumuman </li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal"><span class="fa fa-plus"></span> Tambah Kategori Pengumuman</a>
            </div>
            <!-- /.box-header -->
                ...
                <div class="modal-content">
                    <div class="modal-header">
											<button type="button" class="close" data-dismiss="modal"aria-label="Close">
												...
												<h4 class="modal-title" id="myModalLabel">Tambah Kategori Pengumuman</h4>

                    </div>
                    <form class="form" action="<?php echo base_url().'administrator/kategoripng/simpan_kategori'; ?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                      <div class="form-group row">
                           <label for="inputUserName" class="col-sm-3 control-label"><h5>	Nama Kategori Pengumuman </h5></label>
                            <div class="col-sm-9">
                               <input type="text" name="xkategori" class="form-control" id="inputUserName" placeholder="Nama Kategori Pengumuman" required>
                            </div>
                       </div>
										</div>	 
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Edit Kategori Pengumuman</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'administrator/kategoripng/update_kategori'; ?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                      <div class="form-group row">
                           <label for="inputUserName" class="col-sm-3 control-label"><h5>	Nama Kategori Pengumuman </h5></label>
                            <div class="col-sm-9">
															<input type="hidden" name="kode" value="<?php echo $id_kategori; ?>"/>
                               <input type="text" name="xkategori" class="form-control" value="<?php echo $nama_kategori; ?>"  id="inputUserName" placeholder="Nama Kategori Pengumuman" required>
                            </div>
                       </div>
                    <div class="modal-footer">
...
?>
        <div class="modal fade" id="ModalHapus<?php echo $id_kategori; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                        <h4 class="modal-title" id="myModalLabel">Hapus Kategori Pengumuman</h4>
                    </div>
                    <form class="form-horizontal" action="<?php echo base_url().'administrator/kategoripng/hapus_kategori'; ?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
														<input type="hidden" name="kode" value="<?php echo $id_kategori; ?>"/>
                            <p>Apakah Anda yakin mau menghapus Kategori Pengumuman <b><?php echo $nama_kategori; ?></b> ?</p>
