          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              <div class="active tab-pane" id="data">
							...
							<br>
							<br>
									 <a href="<?= site_url('administrator/barang/cetakKartu/'.$i->id_barang.''); ?>" target="_blank"> <i class="fa fa-file-pdf-o"  style="font-size:30px;color:red;" > Cetak Laporan Persediaan</i></a>
