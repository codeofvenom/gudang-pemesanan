        ...
        <div class="col-md-3">
          <div class="box box-primary">
            <div class="box-body box-profile">
              <img class="lazyload profile-user-img img-responsive img-circle" src="<?php echo base_url().'assets/img/avatar/client/'.$foto; ?> " >
          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              <div class="active tab-pane" id="profile">
							 <form  action="<?php echo base_url().'client/client/update_profil'; ?>" method="post" enctype="multipart/form-data">
							 <br>
                  ...
                  <label for="inputEmail3" class="col-sm-2 control-label"><h4>Nama </h4></label>
											<div class="input-group">
													...
													<input type="text" name="xnama" id="xnama" value="<?php echo $nama; ?>" class="form-control" placeholder="Nama">
