        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            <span class="info-box-icon bg-green"><i class="fa fa-briefcase"></i></span>
                          <div class="info-box-content">
              <span class="info-box-text"><h6>Data Barang</h6></span>
              <span class="info-box-number"><?php echo $count_barang; ?></span>
            </div>
          </div>
        </div>
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            <span class="info-box-icon bg-yellow"><i class="fa fa-truck"></i></span>
                        <div class="info-box-content">
              <span class="info-box-text"><h6>Data Transaksi Pesan</h6></span>
              <span class="info-box-number"><?php echo $count_trx; ?></span>
            </div>
          </div>
        </div>
