      ...
      <ul class="sidebar-menu" >
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo base_url().'administrator/selesai'; ?>"><i class="fa fa-check"></i>  Data Barang Selesai</a></li>
          </ul>
        </li>
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-header">
              <a href="<?=site_url('administrator/selesai/cetakBukuMasuk'); ?>" target="_blank">
                ...
                &nbsp;
              <a href="<?=site_url('administrator/selesai/cetakBukuKeluar'); ?>" target="_blank">
